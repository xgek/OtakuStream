...
#[derive(Debug)]
pub struct OtakuStreamProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OtakuStreamProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OtakuStream processing");
    
    let mut processor = OtakuStreamProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OtakuStreamProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OtakuStreamProcessor::new(false);
